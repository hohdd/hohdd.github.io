...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">1. if something is up to you, you are the person who makes a decision about it</div>
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">-> you’re on next .Someone’s turn is the time when they can or must do something, because they are with other people who are each doing the same activity one after the other.</div>
...
| **I have been** learn**ing** English *for* almost ten years. | Tôi đã học tiếng Anh được gần mười năm.
| **I have been** liv**ing** here *for* thirty years. | Tôi đã sống ở đây ba mươi năm.
| Where have you been? **We have been** look**ing** *for* you everywhere. | Bạn đã ở đâu Chúng tôi đã tìm kiếm bạn ở khắp mọi nơi.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}

**II. DIALOGUES:**

| A: What’s the matter? You look so tired lately. | Có chuyện gì vậy? Dạo này trông bạn mệt mỏi quá.
| B: **I haven’t been** sleep**ing** very well these past *few* nights. | Tôi đã không ngủ ngon mấy đêm nay.
...
| **No matter *what*** he says, don’t believe him. | **Dù** anh ta nói gì đi nữa, đừng tin anh ta.
| **No matter *how*** you do it, it will be wrong. | **Dù cho** bạn có làm như thế nào đi chăng nữa thì cũng sẽ sai.
| **No matter *where*** he goes, he carries his suitcase. | **Dù** đi đâu, anh ấy cũng mang theo vali của mình.
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">->chỉ ra rằng bạn đã đột nhiên nhận ra điều gì đó, thường là một điều gì đó hiển nhiên.</div>
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">sử dụng cách diễn đạt này khi bạn đang nói về hai sự kiện khác nhau hoặc hai cách suy nghĩ đối lập về một tình huống.</div>
...
| **Thank you for** what you have done for me. | **Cảm ơn** bạn **vì** những gì bạn đã làm cho tôi.
| **Thank you for** your help. | **Cám ơn vì** bạn đã giúp.
| **Thank you for** the gift. | **Cảm ơn** **vì** món quà.
| **Thank you for** giving me a lift. | **Cảm ơn** bạn đã cho tôi một thang máy.
| **Thank you for** your advice. | **Cảm ơn** **vì** lời khuyên của bạn.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
| **The first thing I’m going to do when** *I get home* **is** sleep for a whole day. | **Điều đầu tiên tôi sẽ làm khi** *về đến nhà* **là** ngủ cả ngày.
| **The first thing I’m going to do when** *I get a pay raise* **is** to treat you to dinner. | **Điều đầu tiên tôi sẽ làm khi** *được tăng lương* **là** đãi bạn bữa tối.
| **The first thing I’m going to do when** *I spend my vacation in the country* **is** go fishing. | **Điều đầu tiên tôi sẽ làm khi** *dành kỳ nghỉ ở nông thôn* **là** đi câu cá.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
| **There is nothing as** *exciting* **as** meet**ing** an old friend unexpectedly. | **Không có gì** *thú vị* **bằng việc** *gặp lại* một người bạn cũ một cách bất ngờ.
| For me, **There is nothing as** *enjoyable* **as** read**ing** a novel on the grass. | Đối với tôi, **Không có gì** *thú vị* **bằng** *đọc một cuốn tiểu thuyết* trên bãi cỏ.
| **There is nothing as** *pleasant* **as** spend**ing** a weekend in the countryside. | **Không có gì** *dễ chịu* **bằng** *dành một ngày cuối tuần* ở nông thôn.
| **There is nothing as** *refreshing* **as** hav**ing** a good rest. | **Không có gì** *sảng khoái* **bằng được** *nghỉ ngơi* thoải mái.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
| A: I know what you mean. **There’s nothing as** *good* **as** home cook**ing**. | Tôi biết bạn muốn nói gì. **Không gì** *ngon* **bằng** *nấu ăn* tại nhà.
...
| **There is nothing *I* like better than** listen**ing** to the radio. | **Không có gì *tôi* thích hơn là** nghe đài.
| **There is nothing *women* like better than** shopp**ing**. | **Không có gì *phụ nữ* thích hơn là** mua sắm.
| **There is nothing *she* like*s* better than** chatt**ing** with friends. | **Không có gì *cô ấy* thích hơn là** trò chuyện với bạn bè.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
| **What do you mean by** say**ing** that? | **Ý bạn là gì khi** nói vậy?
| **What do you mean by** cancel**ing** your performance? | **Ý bạn là gì khi** hủy bỏ buổi biểu diễn của mình?
| **What do you mean by** “out of the question”? | Bạn có nghĩa là gì khi "ngoài câu hỏi"?
| **What do you mean by** ask**ing** such a question? | Bạn có ý gì khi hỏi một câu hỏi như vậy?
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
| Boyfriend: **What do you mean by** say**ing** that? | *Nói* **vậy là có ý gì?**
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">-> được sử dụng để mô tả một đồ vật hoặc người mà bạn không biết hoặc không thể nhớ tên.</div>
...
| **What do you say** ***about*** go**ing** to the cinema this afternoon? | **Bạn thấy sao về việc** *đi xem phim* vào chiều nay?
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">> được sử dụng để nói rằng điều gì đó không có khả năng tạo ra kết quả thành công và vì vậy không có ích gì khi làm điều đó</div>

**I. EXAMPLES:**

| **What’s the use of** talk**ing** about it? | *Nói* về nó **có ích gì?**
| **What’s the use of** cry**ing** over spilt milk? | Việc *khóc* vì sữa tràn **có ích gì?**
| **What’s the point of** argu**ing** with her? | *Tranh luận* với cô ấy **có ích lợi gì?**
| **What’s the point of** worry**ing** about it? | *Lo lắng* về nó **có ích gì?**
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
| **Where there are** *difficulties*, **there are** *ways* to get over them. | *Khó khăn* **ở đâu** cũng **có** *cách* vượt qua.
...
| Father: Don’t worry, Son. If you really want to go there, then I’m sure you will get in. Remember, **where there’s** *a will* **there’s** *a way*. | Con đừng lo lắng. Nếu bạn thực sự muốn đến đó, thì tôi chắc chắn bạn sẽ vào được. Hãy nhớ rằng, **có** *ý chí* **thì sẽ có** *đường*.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">-> trong bất kỳ hoàn cảnh nào; bất kể</div>

**I. EXAMPLES:**

| **Whether** *it rains* **or not**, we’ll hold the sports meet. | **Dù** trời có mưa **hay không**, chúng tôi sẽ tổ chức đại hội thể thao.
...
| **Whether or not** *we like it*, we have to accept it. | **Dù** *thích* **hay không**, chúng ta phải chấp nhận.
...
| B: Look, I already paid for the tickets, so **whether** *you like it* **or not** we’re going to finish watching it. | Nghe này, tôi đã trả tiền mua vé, vì vậy, **dù** *bạn có thích* **hay không**, chúng ta sẽ xem xong.
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">-> dùng để hỏi một cách lịch sự xem ai đó có muốn thứ gì đó không</div>
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">-> thừa nhận hướng dẫn hoặc quy định</div>
...
<div class="w3-card w3-leftbar w3-border-green w3-pale-green w3-panel w3-padding-16">-> "Bạn không bao giờ được lái xe quá cẩn thận" có nghĩa là bạn phải luôn rất cẩn thận, và không có gì gọi là QUÁ cẩn thận, vì bạn càng cẩn thận thì càng tốt.</div>
