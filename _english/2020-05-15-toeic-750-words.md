...
|	**If you want** {% u to rent %} *the appartment*, **you have to pay** *a two-month deposit*.	|	Nếu anh muốn thuê căn hộ, anh phải đặt tiền cọc 2 tháng.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
[R]elational Words (từ liên quan/từ loại) [S]ynonyms (đồng nghĩa) [A]ntonyms (trái nghĩa) [C]onfusing Words (gây nhầm lẫn)
- **accummulate** (v) tích lũy
- [S] amass - gather - collect (v) tích lũy, thu thập
- [R] accummulation (n) sự tích lũy

|	**She accummulate** *over a million dollars* **through** *investing*.	|	Cô ấy tích lũy được trên một triệu đô la từ việc đầu tư.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	*If you* **invest wisely**, *you won't lost* **money**.	|	Nếu bạn đầu tư một cách khôn ngoan thì bạn sẽ không mất tiền.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	**About** *two hundred dollars* **is withheld** *from Anna's paycheck* **each month**.	|	Khoảng 200 đô la được giữ lại từ séc phải thanh toán của Anna mỗi tháng.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	*The company* **has many assets** that **is could sell** {% u to raise money %}.	|	Công ty có nhiều tài sản có thể bán để thu tiền.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	**One of the advantages of investing online** {% u is that %} **you don't need to pay commission** *to a broker*.	|	Một trong những thuận lợi của đầu tư trực tuyến là bạn không cần trả tiền hoa hồng cho nhà môi giới.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	**Government expenditute** {% u must be kept %} **under** {% u strict control%}.	|	Chi tiêu của chính phủ được giữ trong tầm kiểm soát nghiêm ngặt.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
