...
|	**The reseach department** {% u is adjacent %} *to* **the design department**.	|	Phòng nghiên cứu bên cạnh phòng thiết kế.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	**We want** *everything to go out* **in perfect condition**.	|	Tôi muốn mọi việc được tiến hành trong điều kiện hoàn hỏa.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	**Our efforts are being hampered** *by a shortage of traned staff*.	|	Những nỗ lực của chúng ta bị cản trở bởi thiếu nhân viên lành nghề.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	**It is your responsibility** {% u to make sure that %} **the quality is exellent**.	|	Trách nhiệm của bạn chính là để đảm bảo rằng chất lượng tốt.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
...
|	**We are anxious** *to talk about it* **as soon as posible**.	|	Chúng tôi háo hức nói về nó càng sớm càng tốt.
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-blue}
