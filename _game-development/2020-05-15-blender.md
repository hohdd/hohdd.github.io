...
- Một số phím tắt **Shortcuts**
    ...
    - **Screen View**:
        ...
        - Viewport Shading Mode (Wireframe, Solid, Material Preview, Rendered): phím tắt "**Z**{:.w3-text-red}" để hiện Menu Tròn. Hoặc **Shift+Z**{:.w3-text-red} để chuyển qua lại giữa Wireframe và Solid, Wireframe kèm luôn cả X-Ray.
        - **Alt + Z**{:.w3-text-red} để On/Off X-Ray giúp lựa chọn cả mặt sau
    - Selections
