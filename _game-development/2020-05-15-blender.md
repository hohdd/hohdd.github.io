...
- Khi **E**xtrude có thể "match" khoảng cách Extrude so với Object khác (giống trong Sketchup) bằng cách giữ Ctrl để bắt điểm ở Object khác (vì Edit Mode chỉ có hiệu lực trên Object đã được chọn trước khi chuyển sang Edit Mode từ Object Mode)
