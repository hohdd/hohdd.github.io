...
|-------|-------|-------|-------|-------|
| *あ ア*{:.w3-pale-red} | い イ | う ウ | え エ | *お オ*{:.w3-pale-red} |
| か カ | き キ | *く ク*{:.w3-light-green} | *け ケ*{:.w3-light-green} | *こ コ*{:.w3-blue} |
| さ サ | *し シ*{:.w3-purple} | す ス | せ セ | *そ ソ*{:.w3-purple} |
| た タ | ち チ | *つ ツ*{:.w3-purple} | て テ | と ト |
| な ナ | に ニ | *ぬ ヌ*{:.w3-amber} | *ね ネ*{:.w3-amber} | の ノ |
| *は ハ*{:.w3-pale-red} | ひ ヒ | ふ フ | へ ヘ | *ほ ホ*{:.w3-pale-red} |
| *ま*{:.w3-orange} *マ*{:.w3-khaki} | み ミ | む *ム*{:.w3-khaki} | *め メ*{:.w3-amber} | *も*{:.w3-orange} モ |
| ら ラ | り リ | *る ル*{:.w3-aqua} | *れ レ*{:.w3-aqua} | *ろ ロ*{:.w3-blue} |
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-orange}

|-------|-------|-------|-------|-------|
| や ヤ |       | *ゆ ユ*{:.w3-deep-orange} |       | *よ ヨ*{:.w3-deep-orange} |
| わ ワ |       |       |       | を ヲ |
|       |       | ん ン |       |       |
{:.w3-table-all.w3-hoverable.w3-card-4.w3-section.th-orange}
